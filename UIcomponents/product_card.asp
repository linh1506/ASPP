...
Sub displaytopProduct(obj)
    Response.Write "<div class='product'><div class='product-img'> <img src='"& obj.Image &"' loading='lazy'></div><div class='product-name'>"& obj.Name &"</div><div class='product-price'>Sold: "& obj.Price &" unit</div></div>"
end sub
%>
